...
mandatory update the api-contract and CLAUDE.md if any api updated or created new.
...
Modules: `auth`, `user`, `project`, `skill`, `education`, `certification`, `setting`, `message`, `testimonial`, `blog`.
